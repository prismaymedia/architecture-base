...
- **Prometheus**: Para recolección de métricas (endpoint `/metrics`)
...
Todos los endpoints y operaciones críticas deben tener spans:
...
**Spans requeridos**:
- HTTP request/response (automático con FastAPI instrumentor)
- Spotify API calls
- Database queries
- Event publishing
...
- `event_publishing_duration_seconds{event_type}` - Latencia de publicación

##### 3. Logs Estructurados

Formato JSON obligatorio con campos estándar:
...
**Tests obligatorios**:
- ✅ Unit tests para emisión de métricas
- ✅ Unit tests para creación de spans
- ✅ Unit tests para formato de logs estructurados
- ✅ Integration tests para propagación de trace context
...
- [x] Documentación de métricas actualizada
